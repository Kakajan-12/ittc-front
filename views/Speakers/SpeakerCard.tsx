...
function SpeakerCard({
  ...
  return (
    ...
    >
      <div className="relative aspect-3/4 w-full bg-linear-to-b from-[#C0C0C000] to-[#333333]">
        {image && (
          <Image
            src={image}
            alt={nameAlt}
        ...
        <div className="absolute inset-0 bg-linear-to-b from-[#C0C0C000] to-[#333333]" />
        <div className="relative flex flex-col lg:gap-2 p-3 lg:p-4 justify-end items-start h-full text-white">
